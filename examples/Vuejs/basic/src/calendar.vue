...
<template>
  ...
  <div class="card">
    <table border="0" width="840" cellspacing="0" style="height:700px;border-left:1px solid; border-top:1px solid;"
      v-show="calendar != null" v-if="calendar != null">
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr v-show="calendar.view == 'month'">
          <th v-for="day in calendar.utils.daysofWeek('short')"
          ...
          <td colspan="7" style="border-right:1px solid;">
            <table cellpadding="5" cellspacing="0" width="100%">
              <tbody>
                <tr>
                  <td></td>
                  <td v-for="date in calendar.weekData?.dates"
                ...
                <tr v-for="slot in calendar.timeSlots">
                  ...
                  <td v-for="date in calendar.weekData?.dates" :data-slot="slot.time"
                    :data-date="calendar.utils.formatDate(date)" :style="(calendar.weekData!.isToday(date)
