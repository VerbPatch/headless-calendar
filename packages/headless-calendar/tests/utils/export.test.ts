...
describe('Export Utilities (RFC 5545)', () => {
  ...
  it('should handle all-day events with VALUE=DATE', () => {
    ...
    expect(ics).toContain('DTEND;VALUE=DATE:20240116'); // End is non-inclusive
  });

  it('should fold long lines', () => {
    const longEvent: CalendarEvent = {
      ...baseEvent,
      title: 'A very long summary that exceeds seventy five characters to test the line folding mechanism of iCalendar export utility'
    };
