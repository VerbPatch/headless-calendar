---
title: Localization
description: Headless Calendar provides robust support for internationalization (i18n), allowing you to display dates, times, and events according to different locales and timezones.
---
