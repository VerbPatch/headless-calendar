...
| <img src="https://cdn.simpleicons.org/jquery" alt="jQuery" height="16" width="16"> jQuery          | [@verbpatch/Jquery-calendar](https://www.npmjs.com/package/@verbpatch/jquery-calendar)     | `npm install @verbpatch/jquery-calendar` OR use direct link `https://cdn.jsdelivr.net/npm/@verbpatch/jquery-calendar/dist/index.umd.js` |
